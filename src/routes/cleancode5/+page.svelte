...
<Post>
  <article slot="post_content">
    ...
    <p><ImgZoom src="/cleancode5/img.png" alt="/cleancode5/img.png"></ImgZoom></p>
    <p>옛날에는 오류를 나타낼 때 에러코드를 던졌다.</p>
    <p>하지만 예외를 던지는 것이 명확하고, 처리 흐름이 깔끔해진다.</p>
    <hr />
    <p><ImgZoom src="/cleancode5/img_1.png" alt="/cleancode5/img_1.png"></ImgZoom></p>
    <ol>
    ...
    <p><ImgZoom src="/cleancode5/img_2.png" alt="/cleancode5/img_2.png"></ImgZoom></p>
    <p><ImgZoom src="/cleancode5/img_3.png" alt="/cleancode5/img_3.png"></ImgZoom></p>
    <p>
    ...
    <blockquote>
      ...
      <p><ImgZoom src="/cleancode5/img_4.png" alt="/cleancode5/img_4.png"></ImgZoom></p>
    </blockquote>
    ...
    <p><ImgZoom src="/cleancode5/img_5.png" alt="/cleancode5/img_5.png"></ImgZoom></p>
    <ul>
    ...
    <p><ImgZoom src="/cleancode5/img_6.png" alt="/cleancode5/img_6.png"></ImgZoom></p>
    ...
    <p><ImgZoom src="/cleancode5/img_7.png" alt="/cleancode5/img_7.png"></ImgZoom></p>
    <ul>
    ...
    <p><ImgZoom src="/cleancode5/img_8.png" alt="/cleancode5/img_8.png"></ImgZoom></p>
    <p>
      <a
    ...
    <p><ImgZoom src="/cleancode5/img_9.png" alt="/cleancode5/img_9.png"></ImgZoom></p>
    <p>
      <a
