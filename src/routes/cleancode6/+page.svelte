...
<Post>
  <article slot="post_content">
    ...
    <p><ImgZoom src="/cleancode6/image.png" alt="/cleancode6/image.png"></ImgZoom></p>
    <h2 id="1"><a href="#1">경계 짓기(1) - 우리 코드를 보호하기</a></h2>
    <h3 id=""><a href="#">캡슐화</a></h3>
    <p><ImgZoom src="/cleancode6/image-1.png" alt="/cleancode6/image-1.png"></ImgZoom></p>
    ...
    <p>
      <ImgZoom src="/cleancode6/image-3.png" alt="from Head First Design Pattern"></ImgZoom>
      <ImgZoom src="/cleancode6/image-2.png" alt="from Head First Design Pattern"></ImgZoom>
    </p>
    <p><ImgZoom src="/cleancode6/image-4.png" alt="from Head First Design Pattern"></ImgZoom></p>
    <p><ImgZoom src="/cleancode6/image-5.png" alt="어댑터패턴 클래스 구조도"></ImgZoom></p>
    <blockquote>
